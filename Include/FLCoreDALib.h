...
{
    public:
        CDPClient(const class CDPClient &);
        CDPClient(void);
        virtual ~CDPClient(void);
        class CDPClient &operator=(const class CDPClient &);
...
{
    public:
        CDPClientProxy(const class CDPClientProxy &);
        CDPClientProxy(void);
        virtual ~CDPClientProxy(void);
        class CDPClientProxy &operator=(const class CDPClientProxy &);
...
{
    public:
        CDPMessage(const class CDPMessage &);
        CDPMessage(void);
        virtual ~CDPMessage(void);
        class CDPMessage &operator=(const class CDPMessage &);
        unsigned char *GetData(void);
        const unsigned long GetSize(void);
...
{
    public:
        CDPMsgList(const class CDPMsgList &);
        CDPMsgList(void);
        virtual ~CDPMsgList(void);
        class CDPMsgList &operator=(const class CDPMsgList &);
...
{
    public:
        CDPServer(const class CDPServer &);
        CDPServer(void);
        virtual ~CDPServer(void);
        class CDPServer &operator=(const class CDPServer &);
...
{
    public:
        CGunWrapper(const class CGunWrapper &);
        CGunWrapper(const char *, struct _GUID &, const char *, unsigned long, unsigned short *);
        virtual ~CGunWrapper(void);
        class CGunWrapper &operator=(const class CGunWrapper &);
...
namespace DALib
{
    ...
    IMPORT bool __cdecl Startup(struct HWND__ *, const char *);
...
{
    public:
        IDPMsgHandler(const class IDPMsgHandler &);
        IDPMsgHandler(void);
        class IDPMsgHandler &operator=(const class IDPMsgHandler &);
...
{
    public:
        MD5Hash(const class MD5Hash &);
        MD5Hash(void);
        virtual ~MD5Hash(void);
        class MD5Hash &operator=(const class MD5Hash &);
