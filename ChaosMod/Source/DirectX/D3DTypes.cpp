...
static uint CalcTextureSize(uint Width, uint Height, uint Depth, D3DFORMAT Format)
{
    switch (static_cast<DWORD>(Format))
    {
        ...
        case D3DFMT_P8:
        case D3DFMT_L8:
        case D3DFMT_A4L4: return Width * Height * Depth;
        case D3DFMT_R5G6B5:
        ...
        case D3DFMT_D16:
        case D3DFMT_UYVY:
        case D3DFMT_YUY2: return Width * 2 * Height * Depth;
        case D3DFMT_R8G8B8: return Width * 3 * Height * Depth;
        ...
        case D3DFMT_D24S8:
        case D3DFMT_D24X8:
        case D3DFMT_D24X4S4: return Width * 4 * Height * Depth;
        case D3DFMT_DXT1: assert(Depth <= 1); return ((Width + 3) >> 2) * ((Height + 3) >> 2) * 8;
        case D3DFMT_DXT2:
        case D3DFMT_DXT3:
        case D3DFMT_DXT4:
        case D3DFMT_DXT5: assert(Depth <= 1); return ((Width + 3) >> 2) * ((Height + 3) >> 2) * 16;
    }
}
