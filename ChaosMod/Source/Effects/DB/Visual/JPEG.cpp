...
{
        void Begin() override { Get<ReshadeManager>()->ToggleTechnique("ChaosMod.fx", "JPEG", true); }

        void End() override { Get<ReshadeManager>()->ToggleTechnique("ChaosMod.fx", "JPEG", false); }
