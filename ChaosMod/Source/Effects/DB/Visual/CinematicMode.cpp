...
{
        void Begin() override { Get<ReshadeManager>()->ToggleTechnique("ChaosMod.fx", "Vignette", true); }

        void End() override { Get<ReshadeManager>()->ToggleTechnique("ChaosMod.fx", "Vignette", false); }
