...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // for single viewport apps. Being agnostic of whether <d3dx9.h> or <DirectXMath.h> can be used, we aren't relying on
...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (!bd->pVB || bd->VertexBufferSize < draw_data->TotalVtxCount)
    {
        ...
        if (bd->pd3dDevice->CreateVertexBuffer(
                bd->VertexBufferSize * sizeof(CUSTOMVERTEX), D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY, D3DFVF_CUSTOMVERTEX, D3DPOOL_DEFAULT, &bd->pVB, nullptr) <
            0)
        {
            return;
        }
