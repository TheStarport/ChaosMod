...
class FlappyArchitecture final : public ActiveEffect
{
    ...
    public:
        explicit FlappyArchitecture(const EffectInfo& effectInfo) : ActiveEffect(effectInfo) {}
};

// clang-format off
SetupEffect(FlappyArchitecture, {
    .effectName = "Flappy Architecture",
    .description = "It makes all the doors go up and down. It looks very funni :)",
